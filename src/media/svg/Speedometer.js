...
export default function Speedometer({ actualSpeed }) {
  // 0 deg - 0 km/h
  // 241 deg - 240 km/h (max)
  const angleValue = (actualSpeed * 241) / 241;
    ...
    >
      <g transform="translate(4.5 4.5)">
        ...
        <circle
          ...
          strokeWidth="2"
        />
        {/* <g transform="translate(-196.5 -293)"><text transform="translate(326.914 516.083)" fill="#153b63" fontSize="55.83" fontFamily="SegoeUI, Segoe UI">
<tspan x="0" y="0">0</tspan><tspan y="0" fill="#fff">97</tspan></text>
</g>  */}
        <text
      ...
      <g transform="translate(211.5 211.5) rotate(105)">
        <line
          transform={angle}
          x1="78"
          y1="78"
